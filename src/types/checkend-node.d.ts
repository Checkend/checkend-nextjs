/**
 * Type declarations for @checkend/node
 * This allows the package to build without the actual dependency
 */

declare module '@checkend/node' {
  export interface CheckendNodeConfig {
    apiKey: string
    endpoint?: string
    environment?: string
  ...
  export interface CheckendNode {
    configure(config: CheckendNodeConfig): void
    flush(): Promise<void>
  }

  const checkend: CheckendNode
